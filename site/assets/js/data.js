...
window.RGI = (function () {
  ...
  const t = {
    id: {
      ...
      'plan.previewLead': 'Struktur bangunan yang kami kerjakan disusun bertahap — dari pondasi, kolom tiap lantai, rangka atap, sampai bentuk rumah jadinya. Gulir untuk melihat urutannya.',
      'plan.previewCta': 'Lihat model lengkap',
    ...
    en: {
      ...
      'plan.previewLead': 'The structures we build, assembled stage by stage — from foundation through each floor’s columns and the roof frame, to the finished house. Scroll to follow the sequence.',
      'plan.previewCta': 'See the full model',
